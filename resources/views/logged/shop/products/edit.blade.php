        ...
        <div class="w-full lg:w-8/12 px-4">
            <div
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                    ...
                    <form action="/admin/categories/edit/{{ $product->id }}" method="post"
                            ...
                            <select name="category_id"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        @if (old('category_id') ?: $product->category_id == $category->id) @selected(true) @endif>{{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
