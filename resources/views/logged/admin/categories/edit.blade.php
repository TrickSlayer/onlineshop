                ...
                <form action="/admin/categories/edit/{{ $category->id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <textarea name="description"
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">{{ old('description') ?: $category->description }}</textarea>
                    </div>
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <textarea name="content" id="content"
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">{{ old('content') ?: $category->content }}</textarea>
                    </div>
