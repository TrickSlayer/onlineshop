                        ...
                        <div
                            ...
                            <div class="flex-auto p-5 lg:p-10">
                                ...
                                <div class="relative w-full mb-3">
                                    ...
                                    <textarea rows="4" cols="80" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
